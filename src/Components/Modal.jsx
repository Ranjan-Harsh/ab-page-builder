...
export default function OpenModal({ handleClose, modalValues, handleModalChange, handleModalSave }) {
    ...
    return (
        <div className="modal-container">
            ...
            <br/>
            <button style={{"backgroundColor": "#0044C1", "color": "white", "border-radius": '2px',
  "border-style": 'solid', "border-color":"#0044C1", "padding": '5px 7px'}} onClick={(e) => handleModalSave(e)}>Save Changes</button>
        </div>
    )
}